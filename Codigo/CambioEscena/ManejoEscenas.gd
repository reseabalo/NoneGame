...
var _loading_screen_scene:PackedScene = preload("res://escenas/CambioEscena/pantalla_carga.tscn")	## reference to loading screen PackedScene
...
func _add_loading_screen(transition_type:String="oscurecer"):
	_transition = "no_ir_transicion" if transition_type == "no_transition" else transition_type
	_loading_screen = _loading_screen_scene.instantiate() as LoadingScreen
	get_tree().root.add_child(_loading_screen)
	_loading_screen.start_transition(_transition)
	
func swap_scenes(scene_to_load:String, load_into:Node=null, scene_to_unload:Node=null, transition_type:String="oscurecer") -> void:
